...
const {generate,ltime}=require('./utils/messages')
...
io.on('connection',(socket)=>{
   ...
   socket.on('join',({username,room},callback)=>{
     ...
     socket.on('sendLocation', (coords, callback) => {
      ...
      io.to(user.room).emit('locationmessage', ltime(user.username, `https://google.com/maps?q=${coords.latitude},${coords.longitude}`));
      callback();
  });
